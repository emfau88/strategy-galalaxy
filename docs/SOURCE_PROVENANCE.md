...
| Four engine/weapon pickup icons from `Foozle_2DS0016_Void_PickupsPack` | `7f90d17…` | Runtime upgrade-card manifest | Direct CC0 reuse for Reactor, Arsenal, Autoloader and Multi Cannon; labels, levels, costs and effects are project-owned. |
