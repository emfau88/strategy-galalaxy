...
| Kla'ed and Nairan core-four base, engine, weapon, shield and destruction PNGs | `7f90d17…` | `assets/factions/klaed/`, `assets/factions/nairan/` | Direct files normalized to stable lowercase runtime aliases. Engine frames and class-specific destruction strips are active behind/after the unified hulls; Bomber has no weapon strip and falls back to projectile/muzzle presentation. |
