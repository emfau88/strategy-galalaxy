...
- `assets/runtime/structures/command-hq-{garden,foundry}-{player,rival}-v1.png`: four map- and faction-specific, strictly orthographic command carriers with authored twin launch bays; door light, upgrades and damage presentation are composed in Canvas.
