...
export const ASSET_GROUPS = Object.freeze({
  boot: Object.freeze({
    ...
    "unified-player-scout": "assets/factions/unified/player-scout-v1.png",
    "unified-player-fighter": "assets/factions/unified/player-fighter-v1.png",
    "unified-player-bomber": "assets/factions/unified/player-bomber-v1.png",
    "unified-player-frigate": "assets/factions/unified/player-frigate-v1.png",
    "unified-enemy-scout": "assets/factions/unified/enemy-scout-v1.png",
    "unified-enemy-fighter": "assets/factions/unified/enemy-fighter-v1.png",
    "unified-enemy-bomber": "assets/factions/unified/enemy-bomber-v1.png",
    "unified-enemy-frigate": "assets/factions/unified/enemy-frigate-v1.png",
    "unified-player-engine": "assets/effects/player-engine-strip-v1.png",
    "unified-enemy-engine": "assets/effects/enemy-engine-strip-v1.png",
    "unified-player-scout-pulse": "assets/projectiles/unified/player-scout-pulse-v1.png",
    "unified-player-fighter-laser": "assets/projectiles/unified/player-fighter-laser-v1.png",
    "unified-player-siege-missile": "assets/projectiles/unified/player-siege-missile-v1.png",
    "unified-player-heavy-cannon": "assets/projectiles/unified/player-heavy-cannon-v1.png",
    "unified-enemy-scout-pulse": "assets/projectiles/unified/enemy-scout-pulse-v1.png",
    "unified-enemy-fighter-laser": "assets/projectiles/unified/enemy-fighter-laser-v1.png",
    "unified-enemy-siege-missile": "assets/projectiles/unified/enemy-siege-missile-v1.png",
    "unified-enemy-heavy-cannon": "assets/projectiles/unified/enemy-heavy-cannon-v1.png",
