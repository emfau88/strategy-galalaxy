...
export const UNIT_DEFINITIONS = freeze({
  scout: freeze({ id: "scout", role: "light", cost: 50, maxHp: 70, speed: 84, collisionRadius: 8, attackRange: 68, aggroRange: 126, targetLeash: 158, damage: 5, fireInterval: 1.45, projectileId: "light_bolt", color: "#7ee7ff" }),
  fighter: freeze({ id: "fighter", role: "light", cost: 90, maxHp: 120, speed: 70, collisionRadius: 10, attackRange: 78, aggroRange: 142, targetLeash: 176, damage: 10, fireInterval: 1.5, projectileId: "light_bolt", color: "#a9c7ff" }),
  bomber: freeze({ id: "bomber", role: "siege", cost: 140, maxHp: 100, speed: 50, collisionRadius: 11, attackRange: 94, aggroRange: 154, targetLeash: 190, damage: 26, fireInterval: 1.75, projectileId: "heavy_bolt", color: "#ffd58a" }),
  frigate: freeze({ id: "frigate", role: "heavy", cost: 180, maxHp: 320, speed: 40, collisionRadius: 15, attackRange: 86, aggroRange: 148, targetLeash: 184, damage: 16, fireInterval: 1.35, projectileId: "heavy_bolt", color: "#b69cff" }),
...
export const PROJECTILE_DEFINITIONS = freeze({
  light_bolt: freeze({ id: "light_bolt", speed: 260, lifetime: 1.6, hitRadius: 4, color: "#b9f4ff" }),
  heavy_bolt: freeze({ id: "heavy_bolt", speed: 210, lifetime: 1.9, hitRadius: 5, color: "#ffd27b" }),
});

export const STRUCTURE_DEFINITIONS = freeze({
  hq: freeze({ id: "hq", maxHp: 1800, collisionRadius: 30, attackRange: 150, targetLeash: 185, damage: 12, fireInterval: 1.65, projectileId: "light_bolt", color: "#e2f3ff" }),
  turret: freeze({ id: "turret", maxHp: 340, collisionRadius: 20, attackRange: 142, targetLeash: 172, damage: 9, fireInterval: 1.5, projectileId: "light_bolt", color: "#95d4ff" }),
});
